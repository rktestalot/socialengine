...
namespace :social_engine do   
  
  desc  'Assign admin role to user. Usage: rake social_engine:make_admin email=admin@foo.com'
  ...
  # desc 'Test the social_engine plugin.'
  # Rake::TestTask.new(:test) do |t|         
  #   t.libs << 'lib'
  #   t.pattern = 'vendor/plugins/social_engine/test/**/*_test.rb'
  #   t.verbose = true    
  # end
  # Rake::Task['social_engine:test'].comment = "Run the social_engine plugin tests."
  
  # namespace :db do
  #   namespace :fixtures do
  #     desc "Load social engine fixtures"
  #     task :load => :environment do
  #       require 'active_record/fixtures'
  #       ActiveRecord::Base.establish_connection(Rails.env.to_sym)
  #       Dir.glob(File.join(Rails.root, 'vendor', 'plugins', 'social_engine','test','fixtures', '*.{yml,csv}')).each do |fixture_file|
  #         Fixtures.create_fixtures('vendor/plugins/social_engine/test/fixtures', File.basename(fixture_file, '.*'))
  #       end
  #     end
  #   end
  # end
